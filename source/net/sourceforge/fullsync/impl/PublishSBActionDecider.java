		...
		switch (state.getType()) {
			...
			case State.DirHereFileThere:
				...
				if (buff.equals(State.Orphan, Location.Buffer)) {
					actions.add(new Action(Action.Delete, Location.getOpposite(state.getLocation()), BufferUpdate.Source,
			...
			case State.FileChange:
				if (bsd.getState(src).equals(State.NodeInSync, Location.Both)) {
					...
					actions.add(new Action(Action.UnexpectedChangeError, Location.Destination, BufferUpdate.Source,
