...
public class TwoWaySyncActionDecider implements ActionDecider
{
    ...
    private static final Action updateDestination = new Action( Action.Update, Location.Destination, BufferUpdate.Destination, "source changed, update destination" );
    private static final Action updateSource = new Action( Action.Update, Location.Source, BufferUpdate.Source, "destination changed, update source" );
    private static final Action overwriteDestination = new Action( Action.Update, Location.Destination, BufferUpdate.Destination, "overwrite destination changes" );
    private static final Action overwriteSource = new Action( Action.Update, Location.Source, BufferUpdate.Source, "overwrite source changes" );
    ...
    private static final Action deleteSourceOrphan = new Action( Action.Delete, Location.Source, BufferUpdate.Source, "Delete orphan in source", false );
...
*/
    	...
    	throws DataParseException, IOException
    {
        ...
        case State.DirHereFileThere:
            actions.add( new Action( Action.DirHereFileThereError, state.getLocation(), BufferUpdate.None, "file changed from/to dir, can't overwrite") );
        	break;
