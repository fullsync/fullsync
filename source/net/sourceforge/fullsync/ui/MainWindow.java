...
import net.sourceforge.fullsync.TimerUpdateListener;
...
public class MainWindow extends org.eclipse.swt.widgets.Composite 
	implements ProfileSchedulerListener, ProfileListControlHandler, TaskGenerationListener, TimerUpdateListener
{
	...
	public MainWindow(Composite parent, int style, GuiController initGuiController) 
	{
        ...
        timerStatusChanged(pm.isTimerEnabled());
	}
	...
	*/
	...
	public void timerStatusChanged(boolean status) {
