...
public class PublishOverwriteActionDeciderTest extends ActionDeciderTestUtil {
	private PublishOverwriteActionDecider decider;

	@Override
	@BeforeEach
	protected void setUp() {
		super.setUp();
		decider = new PublishOverwriteActionDecider();
	}
